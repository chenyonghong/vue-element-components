<template>
  <div>
    <div :id="randomId" :class="['el-upload', showLoadBtn ? '' : 'el-no-tips']">
      ...
      >
        <div v-if="file.isUpload">
          <img
            ...
            :alt="file.fileName"
          />
          <div v-else-if="fileTypeFunc(file.fileName) === 2" class="other-file">
            <i class="el-icon-film"></i>
            <span>{{ file.fileName }}</span>
          </div>
          <div v-else-if="fileTypeFunc(file.fileName) === 3" class="other-file">
            <i class="el-icon-document"></i>
            <span>{{ file.fileName }}</span>
          </div>
          <div v-else-if="fileTypeFunc(file.fileName) === 4" class="other-file">
...
export default {
  ...
  methods: {
    ...
    handlePictureCardPreview(file) {
      let tapIndex = 0;
      this.imageViwer.update();
      if (this.imageViwer.images && this.imageViwer.images instanceof Array) {
